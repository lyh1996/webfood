...
public class Test {
	...
	public static void main(String[] args) {
		...
		//查看指定用户是否登录
		System.out.println(  UserRedis.isUserOnline(jedis, "onLineUserPerDay:20161012", 3) );
		System.out.println(  UserRedis.isUserOnline(jedis, "onLineUserPerDay:20161012", 1000) );
		
		//统计某天的在线人数
		System.out.println(   UserRedis.getOnLineUserCount(jedis, "onLineUserPerDay:20161112") );
		//统计连续三天上线的人数
